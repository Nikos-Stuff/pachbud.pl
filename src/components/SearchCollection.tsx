    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
      ...
      <div class="col-span-3 sm:col-span-1">
        <div class="sticky top-24 mt-7">
          {/* Search Bar */}
          <SearchBar onSearchInput={onSearchInput} query={query} setQuery={setQuery} placeholderText={`Wyszukaj`} />
          {/* Tag Filters */}
          <div class="relative flex flex-row justify-between w-full"><p class="text-sm font-semibold uppercase my-4 text-black dark:text-white">Tagi</p>
            {filter().size > 0 && (
              <button
      ...
      <div class="col-span-3 sm:col-span-2">
        <div class="flex flex-col">
          ...
          <div class='flex justify-between flex-row mb-2'>
            ...
            <button onClick={toggleDescending} class='flex flex-row gap-1 stroke-neutral-400 dark:stroke-neutral-500 hover:stroke-neutral-600 hover:dark:stroke-neutral-300 text-neutral-400 dark:text-neutral-500 hover:text-neutral-600 hover:dark:text-neutral-300 transition-all'>
              <div class="text-sm uppercase">
